 ...
 * @author Thomas
 */
public class NewMission extends javax.swing.JFrame {
     ...
     */
    public NewMission(Hygrochron hygrochron) throws OneWireException{
        HYGROCHRON = true;
    ...
    public NewMission(Thermochron thermochron) throws OneWireException{
        THERMOCHRON = true;
    ...
    private void startNewMissionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startNewMissionButtonActionPerformed
        ...
        if(THERMOCHRON)
                ...
                {
                    JOptionPane.showMessageDialog(null,"Started new mission!");
                    this.dispose();
                }
            else
                try {
